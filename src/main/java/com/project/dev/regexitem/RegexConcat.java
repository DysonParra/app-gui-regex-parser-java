/*
 * @fileoverview {RegexConcat} se encarga de realizar tareas especificas.
 *
 * @version             1.0
 *
 ...
 *
 * @History v1.0 --- La implementacion de {RegexConcat} fue realizada el 31/07/2022.
 * @Dev - La primera version de {RegexConcat} fue escrita por Dyson A. Parra T.
 */
package com.project.dev.regexitem;

/**
 * TODO: Definición de {@code RegexConcat}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
